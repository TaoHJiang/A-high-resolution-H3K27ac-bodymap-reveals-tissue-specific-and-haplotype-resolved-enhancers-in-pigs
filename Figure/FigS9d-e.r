library(ggpubr)
pdf(file=paste0("./chrX_110390306_110390642_chrX_110336958_110337351_GRIA3",".pdf"),width=4.5,height=3)
ggplot(data = c2,aes(x = log(p1+1),y = log(p2+1)))+geom_point(aes(color=name2),size = 3)+ geom_smooth(method = 'lm',se=F,color='red')+
 ...
 theme(legend.text=element_text(size=15),legend.title=element_blank())+scale_color_manual(values=c(
  "dark blue",rep("black",150)),breaks=c("Brain_25",rep("Other_tissues",150)),labels=c("Brain_25",rep("Other_tissues",150)))+
